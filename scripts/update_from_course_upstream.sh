...
: ${GITURL_BASE_SSH:="git@course-gitlab.tuni.fi:tie-50307-real-time-systems_2019-2020"}
: ${GITURL_BASE_HTTPS:="https://course-gitlab.tuni.fi/tie-50307-real-time-systems_2019-2020"}
